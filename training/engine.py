...
def run_training_loop(*, components: TrainingComponents, run_name: str, config_name: str = "unknown") -> TrainResult:
    ...
    metrics = {
        ...
        "answer_eval_numeric_multi_value_rule": training_summary.get("answer_eval_numeric_multi_value_rule", "any"),
    ...
    answer_eval_diagnostics = {
        ...
        "notes": "Answer metrics decode only tokens in answer_mask/final_answer_mask (answer span, excluding the literal 'Final Answer:' header). stage_3_token_accuracy still uses the full stage3_mask section.",
    }
